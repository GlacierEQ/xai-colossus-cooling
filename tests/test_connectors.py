...
CIRCUIT_MANIFEST = {
    ...
    "circuits": [
        {"circuit_id": "CIRCUIT-01", "nanoparticle": "Al2O3", "volume_fraction_pct": 2.5,
         "effective_conductivity_w_mk": 0.72, "degradation_pct": 5.0, "status": "active", "replacement_due": False},
        {"circuit_id": "CIRCUIT-02", "nanoparticle": "TiO2", "volume_fraction_pct": 3.0,
         "effective_conductivity_w_mk": 0.75, "degradation_pct": 17.0, "status": "degraded", "replacement_due": True},
        {"circuit_id": "CIRCUIT-03", "nanoparticle": "CuO", "volume_fraction_pct": 1.5,
         "effective_conductivity_w_mk": 0.68, "degradation_pct": 3.0, "status": "active", "replacement_due": False},
        {"circuit_id": "CIRCUIT-05", "nanoparticle": "graphene", "volume_fraction_pct": 0.5,
         "effective_conductivity_w_mk": 0.90, "degradation_pct": 1.0, "status": "active", "replacement_due": False},
    ]
}
...
POWER_STATE_SNAPSHOT = {
    ...
    "zones": [
        {"zone_id": "ZONE-A", "draw_kw": 240000, "compute_kw": 210000, "cooling_kw": 30000,
         "rack_count": 512, "avg_inlet_temp_c": 20.5, "avg_outlet_temp_c": 38.2},
        {"zone_id": "ZONE-B", "draw_kw": 235000, "compute_kw": 205000, "cooling_kw": 30000,
         "rack_count": 512, "avg_inlet_temp_c": 21.0, "avg_outlet_temp_c": 39.5},
        {"zone_id": "ZONE-C", "draw_kw": 245000, "compute_kw": 215000, "cooling_kw": 30000,
         "rack_count": 512, "avg_inlet_temp_c": 20.0, "avg_outlet_temp_c": 41.1},
        {"zone_id": "ZONE-D", "draw_kw": 230000, "compute_kw": 200000, "cooling_kw": 30000,
         "rack_count": 512, "avg_inlet_temp_c": 20.3, "avg_outlet_temp_c": 37.8},
    ]
}
...
class TestPowerStateBridge:
    ...
    def test_unknown_zone_skipped(self):
        bridge = self._make_bridge()
        bad_snapshot = {**POWER_STATE_SNAPSHOT,
...
class TestMCPRouter:
    ...
    async def test_zone_snapshot_offline(self):
        from mastermind_fusion.mcp_router import MCPRouter, MCPRequest, RequestType, ResponseStatus
